...
class CarrinhosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create carrinho" do
    assert_difference('Carrinho.count') do
      post carrinhos_url, params: { carrinho: { estado: @carrinho.estado, usuario: @carrinho.usuario } }
    end
  ...
  test "should update carrinho" do
    patch carrinho_url(@carrinho), params: { carrinho: { estado: @carrinho.estado, usuario: @carrinho.usuario } }

...
class LojasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create loja" do
    assert_difference('Loja.count') do
      post lojas_url, params: { loja: { email: @loja.email, estado: @loja.estado, loja_id: @loja.loja_id, nome: @loja.nome, representante_id: @loja.representante_id, telefone: @loja.telefone } }
    end
  ...
  test "should update loja" do
    patch loja_url(@loja), params: { loja: { email: @loja.email, estado: @loja.estado, loja_id: @loja.loja_id, nome: @loja.nome, representante_id: @loja.representante_id, telefone: @loja.telefone } }

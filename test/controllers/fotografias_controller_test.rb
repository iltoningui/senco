...
class FotografiasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fotografia" do
    assert_difference('Fotografia.count') do
      post fotografias_url, params: { fotografia: { imageable_id: @fotografia.imageable_id } }
    end
  ...
  test "should update fotografia" do
    patch fotografia_url(@fotografia), params: { fotografia: { imageable_id: @fotografia.imageable_id } }

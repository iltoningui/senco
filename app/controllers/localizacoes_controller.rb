...
def gmaps4rails_marker_picture
  ...
  private
    ...
    def localizacao_params
      params.require(:localizacao).permit(:latitude, :Latitude, :city, :address, :state, :state_code, :postal_code, :country, :country_code, :tipo, :endereco, :street, :locationable_id)
    end
end
